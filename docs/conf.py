# -*- coding: utf-8 -*-
#
# pytest-auth documentation build configuration file, created by
...
project = 'pytest-auth'
copyright = '2015, Uzochukwu Precious'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-auth Documentation',
     [author], 1)
]
